 ...
 * 表单对话框，扩展jquery-ui-dialog 
 */
$.FormDialogSingleAudit = function(opts){
	var doOk = function($container){
		if($.isFunction(opts.doOk)){
			opts.doOk.call(this,$container);
		}else{
	...
	var doRefuse = function($container){
		if($.isFunction(opts.doRefuse)){
			opts.doRefuse.call(this,$container);
		}else{
			$container.dialog( "destroy" ); 
		}
	};
...
* 表单对话框，扩展jquery-ui-dialog 
*/
$.FormDialogAffirm = function(opts){
	var doOk = function($container){
		if($.isFunction(opts.doOk)){
			opts.doOk.call(this,$container);
		}else{
 ...
 * 表单对话框，扩展jquery-ui-dialog 
 */
$.FormDialogBatchAudit = function(opts){
	var doPass = function($container){
		if($.isFunction(opts.doPass)){
			opts.doPass.call(this,$container);
		}else{
			$container.dialog( "destroy" ); 
		}
	};
	var doNotPass = function($container){
		if($.isFunction(opts.doNotPass)){
			opts.doNotPass.call(this,$container);
		}else{
			$container.dialog( "destroy" ); 
		}
	};
