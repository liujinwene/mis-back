...
//	}
	 ...
	 * 所有支持的视频MIME TYPES
	 */
	public final static String[] video_exts = new String[]{"flv","avi","rm","3gp","wmv","mpg","asf"};
	 ...
	 * 文档类型
	 */
	public final static String[] docs_exts = new String[]{"zip","rar","7z","tar","gzip","pdf","doc","docx","rtf","xls","xlsx","ppt","pptx"};

	public final static HashMap<String, String> mime_types = new HashMap<String, String>()
	{/**
		 * 
		 */
		private static final long serialVersionUID = 2152684387773691371L;
